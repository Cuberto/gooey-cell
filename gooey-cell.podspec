...
Pod::Spec.new do |s|
  s.name             = 'gooey-cell'
  s.version          = '0.1.0'
  s.summary          = 'A short description of gooey-cell.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Прегер Глеб/gooey-cell'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Прегер Глеб' => 'gleb.preger@cuberto.ru' }
  s.source           = { :git => 'https://github.com/Прегер Глеб/gooey-cell.git', :tag => s.version.to_s }
